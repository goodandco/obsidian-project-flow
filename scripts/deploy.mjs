...
async function main() {
  try {
    ...
    if (!vaultPath) {
      vaultPath = await ask(
        "Enter your Obsidian vault path (absolute). Example: /Users/<user>/path/to/MyVault\n> ",
      );
    }
    ...
    console.log(
      '[deploy] Tip: In Obsidian, toggle the plugin off/on or use "Force reload" to pick up changes.',
    );
  } catch (e) {
